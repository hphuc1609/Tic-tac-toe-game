  ...
  return (
    <div className='flex flex-col'>
      <motion.main
        ...
        exit={{ opacity: 0, y: -20 }}
        className='m-auto min-w-[300px] flex flex-col items-center justify-around gap-10'
      >
        <Logo />
        <div className='w-full flex flex-col gap-7'>
          <button
            ...
            className='button-3d button-3d-click flex items-center justify-center gap-2 w-full h-16 !px-5 bg-primary uppercase tracking-widest font-semibold text-xl !shadow-[0_8px_0_#0284c7] active:!shadow-[0_4px_0_#0284c7] hover:bg-sky-400'
          >
            <svg
